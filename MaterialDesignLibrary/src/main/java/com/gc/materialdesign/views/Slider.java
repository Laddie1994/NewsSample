...
public class Slider extends CustomView {
    ...
    private int value = 0;
    private int mBallColor = Color.parseColor("#4CAF50");
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    if (onValueChangedListener != null)
                        onValueChangedListener.onStartTrackingTouch(this);
                ...
                case MotionEvent.ACTION_UP:
                    if (onValueChangedListener != null)
                        onValueChangedListener.onStopTrackingTouch(this);
                    if (numberIndicator != null)
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams params = new LayoutParams(Utils.dpToPx(15,
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(ViewHelper.getX(ball) + Utils.getRelativeLeft((View) ball.getParent())
                    + ball.getWidth() / 2, y, size, paint);
            if (animate && size >= finalSize)
                animate = false;
            if (animate == false) {
                ViewHelper.setX(numberIndicator.numberIndicator,
                        (ViewHelper.getX(ball) + Utils.getRelativeLeft((View) ball
                                .getParent()) + ball.getWidth() / 2) - size);
                ViewHelper.setY(numberIndicator.numberIndicator, y - size);
                String tempStr = TextUtils.isEmpty(mIndicatorText) ? String.valueOf(value) : mIndicatorText;
                numberIndicator.numberIndicator.setText(tempStr);
            }
...
//            super(context, android.R.style.Theme_Translucent);
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            indicator.addView(numberIndicator);
