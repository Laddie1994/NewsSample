...
//        String udid = UIUtils.getPreferences().getString("udid", "");
//        if (udid.length() == 0) {
...
//    }
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (AppContext.getContext().getResources().getConfiguration().orientation == 2)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static String getCurCountryLan() {
        return AppContext.getContext().getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + AppContext.getContext().getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = AppContext.getContext().getResources()
    ...
    public static void copyTextToBoard(String string) {
        if (TextUtils.isEmpty(string))
            return;
        ClipboardManager clip = (ClipboardManager) AppContext.getContext()
