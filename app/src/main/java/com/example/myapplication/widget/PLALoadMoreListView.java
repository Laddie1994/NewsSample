...
import com.github.library.PinterestLikeAdapterView.PLAAbsListView;
import com.github.library.progress.CircularProgressBar;
 ...
 * Description:
 */
public class PLALoadMoreListView extends MultiColumnListView implements PLAAbsListView.OnScrollListener {
    ...
    private void init(Context context) {
        ...
        // footer
        mFooterView = (RelativeLayout) mInflater.inflate(R.layout.loading_more_layout, this, false);
        mLabLoadMore = (TextView) mFooterView.findViewById(R.id.loading_more_msg);
        mProgressBarLoadMore = (CircularProgressBar) mFooterView.findViewById(R.id.loading_more_pb);
