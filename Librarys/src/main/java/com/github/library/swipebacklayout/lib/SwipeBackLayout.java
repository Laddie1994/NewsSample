package com.github.library.swipebacklayout.lib;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void attachToActivity(Activity activity) {
        ...
        applyKitKatTranslucency(activity);
    }

    private int mStatusColor = Color.BLACK;
    public void setStatusBarColor(int color){
        mStatusColor = getResources().getColor(color);
    }

    private void applyKitKatTranslucency(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setTranslucentStatus(activity,true);
        }
        SystemBarTintManager tintManager = new SystemBarTintManager(activity);
        tintManager.setStatusBarTintColor(mStatusColor);
